...
dfValues = pd.read_json('/Users/karolinaryzka/Documents/neo4jQueries/BaseMetricFiles/outDegreeFrequency.json', encoding='utf-8-sig')
...
#mean stat
meanDf = pd.read_json('/Users/karolinaryzka/Documents/neo4jQueries/StatMetrics/avgOutDegree.json', encoding='utf-8-sig')
meanValue = meanDf['mean'][0]  

#median stat
medianDf = pd.read_json('/Users/karolinaryzka/Documents/neo4jQueries/StatMetrics/medianOutDegree.json', encoding='utf-8-sig')
medianValue = medianDf['median'][0]  

#mode stat
modeDf = pd.read_json('/Users/karolinaryzka/Documents/neo4jQueries/StatMetrics/modeOutDegree.json', encoding='utf-8-sig')
modeValue = modeDf['mode'][0]  

#standard deviation stat
stdDevDf = pd.read_json('/Users/karolinaryzka/Documents/neo4jQueries/StatMetrics/stDevOutDegree.json', encoding='utf-8-sig')
...
plt.legend()
plt.title('Exponential Distribution of Node out-Degrees')
plt.xlabel('Degree')
plt.ylabel('Probability Density')
plt.savefig('/Users/karolinaryzka/Documents/neo4jQueries/Visualizations/expDistrOutDegree.png')