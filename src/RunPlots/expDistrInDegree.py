...
dfValues = pd.read_json(
    "/Users/karolinaryzka/Documents/neo4jQueries/BaseMetricFiles/inDegreeFrequency.json",
    encoding="utf-8-sig",
)
...
# mean stat
meanDf = pd.read_json(
    "/Users/karolinaryzka/Documents/neo4jQueries/StatMetrics/avgInDegree.json",
    encoding="utf-8-sig",
)
...
medianDf = pd.read_json(
    "/Users/karolinaryzka/Documents/neo4jQueries/StatMetrics/medianInDegree.json",
    encoding="utf-8-sig",
)
...
# mode stat
modeDf = pd.read_json(
    "/Users/karolinaryzka/Documents/neo4jQueries/StatMetrics/modeInDegree.json",
    encoding="utf-8-sig",
)
...
stdDevDf = pd.read_json(
    "/Users/karolinaryzka/Documents/neo4jQueries/StatMetrics/stDevInDegree.json",
    encoding="utf-8-sig",
)
...
plt.legend()
plt.title("Exponential Distribution of Node in-Degrees")
plt.xlabel("Degree")
plt.ylabel("Probability Density")
plt.savefig(
    "/Users/karolinaryzka/Documents/neo4jQueries/Visualizations/expDistrInDegree.png"
)
